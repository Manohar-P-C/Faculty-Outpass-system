...
@app.route("/")
def home():
    # Auto-redirect logged-in users to their dashboard (no animation)
    ...
    # If not logged in, always show the intro animation
...
def main_portal():
    ...
    # Show role login selection page
    return render_template("main.html")


@app.route("/intro")
def view_intro():
    """Explicitly view the intro animation."""
    return render_template("intro.html")
